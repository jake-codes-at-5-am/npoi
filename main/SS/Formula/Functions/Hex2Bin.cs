...
namespace NPOI.SS.Formula.Functions
{
    ...
    /**
     * Implementation for Excel HEX2BIN() function.
     * Syntax: HEX2BIN(number, [places])
     *
     * Converts a hexadecimal number to binary. Output is limited to a 10-bit
     * signed binary value, so the decoded decimal must be within -512..511.
     */
    public class Hex2Bin : Var1or2ArgFunction, FreeRefFunction
    {
        public static FreeRefFunction instance = new Hex2Bin();
        ...
        public override ValueEval Evaluate(int srcRowIndex, int srcColumnIndex, ValueEval numberVE, ValueEval placesVE)
        {
            return BaseConversionUtils.Convert(numberVE, placesVE, srcRowIndex, srcColumnIndex,
                HexBase, MaxInputPlaces, BaseConversionUtils.OutputBase.Binary);
        }
